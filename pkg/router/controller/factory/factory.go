...
func (lw *serviceLW) List() (runtime.Object, error) {
	return lw.client.Services(lw.namespace).List(labels.Everything(), fields.Everything())
}

func (lw *serviceLW) Watch(resourceVersion string) (watch.Interface, error) {
	return lw.client.Services(lw.namespace).Watch(lw.label, lw.field, resourceVersion)
}
